...
namespace Cookery.Infrastructure.Migrations
{
    ...
    [Migration("20221109031148_NutritionalInformationAndRecipeRelationship")]
    partial class NutritionalInformationAndRecipeRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cookery.ApplicationCore.Models.Difficulty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cookery.ApplicationCore.Models.FoodCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cookery.ApplicationCore.Models.Measurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cookery.ApplicationCore.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OrginCountry")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("PreprationTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Cookery.ApplicationCore.Models.RecipeStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cookery.ApplicationCore.Models.Recipe", b =>
                {
                    b.HasOne("Cookery.ApplicationCore.Models.Difficulty", "Difficulty")
                        .WithMany("Recipe")
